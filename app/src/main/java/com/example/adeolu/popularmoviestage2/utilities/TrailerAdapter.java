...
public class TrailerAdapter extends RecyclerView.Adapter<TrailerAdapter.TrailerHoldeer> {
    ...
    private List<JSONObjectUtil.TrailerJSonResponse> trailerlist;
    private int count =0;
    public TrailerAdapter(Context context,TrailerAdapterOnClickListener clickListener){
        mcontex = context;
        mClickListener = clickListener;
    }
    public void setTrailerlistData(List<JSONObjectUtil.TrailerJSonResponse> vtrailerlist){
    ...
    public interface TrailerAdapterOnClickListener{
        void onclick(JSONObjectUtil.TrailerJSonResponse response);
    }
